...
var file_pb_demo_proto_rawDesc = string([]byte{
	...
	0x67, 0x65, 0x32, 0xee, 0x01, 0x0a, 0x0b, 0x44, 0x65, 0x6d, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x38, 0x0a, 0x0d, 0x4c, 0x6f, 0x74, 0x73, 0x4f, 0x66, 0x52,
	0x65, 0x70, 0x6c, 0x69, 0x65, 0x73, 0x12, 0x10, 0x2e, 0x70, 0x62, 0x2e, 0x48, 0x65, 0x6c, 0x6c,
	...
	0x3a, 0x0a, 0x0f, 0x4c, 0x6f, 0x74, 0x73, 0x4f, 0x66, 0x47, 0x72, 0x65, 0x65, 0x74, 0x69, 0x6e,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x12, 0x36, 0x0a, 0x09, 0x42,
	0x69, 0x64, 0x69, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x10, 0x2e, 0x70, 0x62, 0x2e, 0x48, 0x65,
	...
	0x01, 0x30, 0x01, 0x42, 0x16, 0x5a, 0x14, 0x72, 0x70, 0x63, 0x30, 0x33, 0x5f, 0x64, 0x65, 0x6d,
...
var file_pb_demo_proto_depIdxs = []int32{
	...
	0, // 1: pb.DemoService.LotsOfReplies:input_type -> pb.HelloRequest
	0, // 2: pb.DemoService.LotsOfGreetings:input_type -> pb.HelloRequest
	0, // 3: pb.DemoService.BidiHello:input_type -> pb.HelloRequest
	1, // 4: pb.DemoService.SayHello:output_type -> pb.HelloResponse
	1, // 5: pb.DemoService.LotsOfReplies:output_type -> pb.HelloResponse
	1, // 6: pb.DemoService.LotsOfGreetings:output_type -> pb.HelloResponse
	1, // 7: pb.DemoService.BidiHello:output_type -> pb.HelloResponse
